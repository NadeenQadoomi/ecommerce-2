  ...
  <div class="app-container">
    <div class="sidebar">
      ...
      <ul class="sidebar-list">
        ...
        <li class="sidebar-list-item">
          <a href="/views/admin/products/index.view.php">
        ...
        <li class="sidebar-list-item">
          <a href="/views/admin/orders/index.view.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-package">
        ...
        <li class="sidebar-list-item">
          <a href="/views/admin/categories/index.view.php">
        ...
        <li class="sidebar-list-item">
          <a href="/views/admin/users/index.view.php">
...
<script src="/views/admin/admins/dist/script.js"></script>